...
import Nav from "./Nav";
import styles from "./RotatingNav.module.css";

const Page = () => (
  <>
    <div class={`${styles.container} show-nav`}>
      <Nav>
        <div class={styles.content}>
          <h1>Amazing Article</h1>
          <small>Andrew Sanchez</small>
          <p>
          ...
          <h3>A Beautiful Bridge </h3>
          <img
            className={styles.content}
            src="https://images.unsplash.com/photo-1574167440892-f018158f20c0?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=3152&q=80"
            alt="gg-bridge"
          />
          <p>
